...
export function IntroRubLoader({ onComplete }: IntroRubLoaderProps) {
  ...
  return (
    <div
      onClick={handleSkip}
      className={`fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#0b2545] select-none transition-opacity duration-500 overflow-hidden cursor-pointer ${
      ...
      <div className="relative max-w-4xl w-full px-6 flex flex-col items-center text-center">
        ...
        <div className="mt-8 max-w-xs w-full">
          <div className="w-full h-4 bg-[#EAEFEF] border-3 border-black rounded-full overflow-hidden p-0.5 shadow-[3px_3px_0_#000]">
            <div
              className="h-full bg-[#ef7618] rounded-full transition-all duration-75 border border-black"
        ...
        {phase === "rubbing" && (
          ...
          >
            ...
            <div className="w-20 sm:w-28 h-10 sm:h-14 bg-[#ef7618] border-3 border-black rounded-lg shadow-[4px_4px_0_#000] flex overflow-hidden">
              <div className="w-2/3 h-full bg-[#ef7618] flex items-center justify-center border-r-2 border-black">
            ...
            <div className="absolute -bottom-2 -left-2 flex gap-1 animate-pulse">
              <div className="w-1.5 h-1.5 rounded-full bg-[#ef7618] border border-black" />
